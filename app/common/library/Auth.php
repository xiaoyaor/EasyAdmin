...
class Auth
{
    ...
    public function init($token)
    {
        ...
        if ($user_id > 0) {
            ...
            //初始化成功的事件
            event_trigger("userInitSuccessed", $this->_user);
    ...
    public function register($username, $password, $email = '', $mobile = '', $extend = [])
    {
        ...
        try {
            ...
            //注册成功的事件
            event_trigger("userRegisterSuccessed", $this->_user, $data);
            Db::commit();
        } catch (Exception $e) {
    ...
    public function logout()
    {
        ...
        //注销成功的事件
        event_trigger("userLogoutSuccessed", $this->_user);
        return true;
    }
    ...
    public function changepwd($newpassword, $oldpassword = '', $ignoreoldpassword = false)
    {
        ...
        if ($this->_user->password == $this->getEncryptPassword($oldpassword, $this->_user->salt) || $ignoreoldpassword) {
            ...
            try {
                ...
                Token::delete($this->_token);
                //修改密码成功的事件
                event_trigger("userChangepwdSuccessed", $this->_user);
                Db::commit();
            } catch (Exception $e) {
                Db::rollback();
                $this->setError($e->getMessage());
    ...
    public function direct($user_id)
    {
        ...
        if ($user) {
            ...
            try {
                ...
                //登录成功的事件
                event_trigger("userLoginSuccessed", $this->_user);
                Db::commit();
            } catch (Exception $e) {
                Db::rollback();
                $this->setError($e->getMessage());
    ...
    public function delete($user_id)
    {
        ...
        try {
            ...
            event_trigger("userDeleteSuccessed", $user);
            Db::commit();
        } catch (Exception $e) {
            Db::rollback();
            $this->setError($e->getMessage());
