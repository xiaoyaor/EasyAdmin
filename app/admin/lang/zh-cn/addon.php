...
return [
    ...
    'Online store'                   => '在线商店',
    'Local addon'                    => '本地插件',
    'AppModule Install'              => '应用模块安装',
    'Applist Success'                => '应用列表获取成功',
    'Select Module Install'          => '选择要安装到的应用',
    ...
    'Not login tips'                 => '你当前未登录EasyAdmin，登录后将同步已购买的记录，下载时无需二次付费！',
    'Not installed tips'             => '请安装后再访问插件前台页面！',
    'Not enabled tips'               => '插件已经禁用,请启用后再访问插件前台页面！',
    'New version tips'               => '发现新版本:%s 点击查看更新日志',
    'Store now available tips'       => 'EasyAdmin插件市场暂不可用，是否切换到本地插件？',
