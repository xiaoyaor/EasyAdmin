...
return [
    ...
    'Addon tips'                                            => '可在线安装、卸载、禁用、启用插件，同时支持添加本地插件。EasyAdmin已上线插件商店 ，你可以发布你的免费或付费插件：<a href="https://cloud.easyadmin.vip" target="_blank">https://cloud.easyadmin.vip</a>。如果你是新手，请点击  <a href="javascript:;" class="btn-guide" style="color: green">插件安装引导助手</a>  ',
