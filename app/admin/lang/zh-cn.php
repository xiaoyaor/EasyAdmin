...
return [
    ...
    'Addon tips'                                            => '可在线安装、卸载、禁用、启用插件，同时支持安装本地插件。EasyAdmin已上线插件市场 ，你可以发布你的免费或付费插件：<a href="https://cloud.easyadmin.vip" target="_blank">官方插件市场</a>。如果你是新手，请点击  <a href="javascript:;" class="btn-guide" style="color: green">插件安装引导助手</a>，<a href="https://doc.easyadmin.vip/volume/easyadmin.html" target="_blank">easyadmin开发文档</a>。',
    'Vendor tips'                                           => '在线安装第三方类库composer扩展，可根据实际情况选装所需最少类库。没有的类库开发者可以composer下来，打包成插件使用，也可以把插件通过插件发布助手发布到官网，审核通过后即可在线安装。<a href="https://doc.easyadmin.vip/volume/vendor.html" target="_blank">参考文档</a>'  ,
