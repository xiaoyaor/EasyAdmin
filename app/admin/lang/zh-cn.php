...
return [
    ...
    'Addon tips'                                            => '可在线安装、卸载、禁用、启用插件，同时支持添加本地插件。EasyAdmin已上线插件商店 ，你可以发布你的免费或付费插件：<a href="https://addons.easyadmin.vip" target="_blank">https://addons.easyadmin.vip</a>',
    'Program tips'                                          => '可在线安装、卸载、禁用、启用应用，同时支持添加本地应用。EasyAdmin已上线应用商店 ，你可以发布你的免费或付费插件：<a href="https://app.easyadmin.vip" target="_blank">https://app.easyadmin.vip</a>',
