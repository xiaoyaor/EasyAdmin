    ...
    var Fast = {
        ...
        api: {
            ...
            open: function (url, title, options) {
                ...
                var area = Easy.config.openArea != undefined ? Easy.config.openArea : [$(window).width() > 800 ? '80%' : '95%', $(window).height() > 600 ? '99.9%' : '95%'];
...
define('frontend',['easy', 'template', 'moment'], function (Fast, Template, Moment) {
    var Frontend = {
        api: Easy.api,
        init: function () {
            var si = {};
